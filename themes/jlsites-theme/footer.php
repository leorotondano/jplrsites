...
<div class="container">
	...
	<?php
		...
		echo '<div class="zerif-copyright-box">'.__('powered by','zerif-lite').'<a class="zerif-copyright" href="http://wordpress.org/"'.$attribut_new_tab.' rel="nofollow"> JLSites</a></div>';
