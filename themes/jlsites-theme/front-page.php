...
<?php
	...
	get_template_part('sections/our_service');
	get_template_part('sections/how_we_work');
					...
					?>
						...
						<div class="row">
							...
							if(isset($emailSent) && $emailSent == true) :
								...
								echo '<div class="notification success"><p>'.__('Obrigado pelo seu contato! Entraremos em contato em breve.','zerif-lite').'</p></div>';

							elseif(isset($_POST['submitted'])):

								echo '<div class="notification error"><p>'.__('Desculpe, não foi possível enviar o e-mail. Por favor tente novamente mais tarde.','zerif-lite').'</p></div>';
							...
							<form role="form" method="POST" action="" onSubmit="this.scrollPosition.value=(document.body.scrollTop || document.documentElement.scrollTop)" class="contact-form">
								...
								<div class="col-lg-4 col-sm-4 zerif-rtl-contact-email" data-scrollreveal="enter left after 0s over 1s">
									...
									<input required="required" type="email" name="myemail" id="myemail" placeholder="<?php _e('E-mail','zerif-lite'); ?>" class="form-control input-box" value="<?php if(isset($_POST['myemail'])) echo is_email($_POST['myemail']) ? $_POST['myemail'] : ""; ?>">
								</div>
								...
								if( !empty($zerif_contactus_button_label) ):
									echo '<button class="btn btn-primary btn_com_relevo botao_enviar_email" type="submit" data-scrollreveal="enter left after 0s over 1s">'.$zerif_contactus_button_label.'</button>';
								elseif ( isset( $wp_customize ) ):
									echo '<button class="btn btn-primary btn_com_relevo botao_enviar_email zerif_hidden_if_not_customizer" type="submit" data-scrollreveal="enter left after 0s over 1s"></button>';
								endif;
								?>
