...
" target="_blank"  style="float:right; margin-bottom:15px; margin-top:5px; font-weight:bold;">
Buy Me a Beer
</a>
...
<div class="egw-row">
    ...
    <select class="widefat"
        ...
        type="text"
        value="<?php esc_attr_e( $instance['get_bg_effects'] ); ?>">
        <?php
...
<div class="egw-row">
    ...
    <select class="widefat"
        ...
        type="text"
        value="<?php esc_attr_e( $instance['captions_effects'] ); ?>">
        <?php
...
<div class="egw-row">
    ...
    <select class="widefat"
        ...
        type="text"
        value="<?php esc_attr_e( $instance['fonts_family'] ); ?>">
        <?php
